...
def main():
    ...
    utils.save_matrix(generated_matrix, positions_params.outdir + '/' + positions_params.file_name + '.mat')
    utils.save_fig(generated_matrix, positions_params.outdir + '/' + positions_params.file_name + '.jpg')
